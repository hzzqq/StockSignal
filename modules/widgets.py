...
_NAV_GROUPS = [
    ('📈 行情与板块', [
        ('行情', [
            ...
            ('pages/76_实时强势榜.py', '实时强势榜', '🏅'),
            ('pages/84_宏观数据.py', '宏观数据', '🌍'),
            ('pages/85_龙虎榜.py', '龙虎榜', '🐯'),
        ]),
        ('板块', [
            ('pages/12_板块轮动.py', '板块轮动', '🌈'),
            ('pages/17_市场魔方.py', '市场魔方', '🧊'),
            ('pages/75_题材热点.py', '题材热点', '🧱'),
        ]),
    ]),
    ('🌐 市场广度·温度', [
        ('广度温度核心', [
    ...
    ('🛠 工具与社区', [
        ...
        ('数据治理', [
            ('pages/73_自定义看板.py', '自定义看板', '🧩'),
            ('pages/74_告警引擎.py', '告警引擎', '🛎️'),
            ('pages/82_数据时效性看板.py', '数据时效性看板', '🔭'),
            ('pages/81_自然语言选股.py', '自然语言选股', '💬'),
        ]),
        ('社区与AI', [
