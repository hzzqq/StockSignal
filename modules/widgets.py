...
_NAV_GROUPS = [
    ...
    ('🔎 个股研究', [('pages/24_个股研究.py', '个股研究', '🎯'), ('pages/11_股票选取.py', '股票选取', '🔍', 'sub'), ('pages/20_个股分析.py', '个股分析', '📈', 'sub'), ('pages/21_多股对比.py', '多股对比', '📊'), ('pages/22_基本面分析.py', '基本面分析', '🏛️')]),
    ('🧪 量化选股', [('pages/32_智能选股.py', '智能选股', '🤖'), ('pages/31_形态选股.py', '形态选股', '🧭'), ('pages/33_ETF筛选.py', 'ETF筛选', '🧰'), ('pages/25_QuantAgent投研.py', 'QuantAgent投研', '🧠'), ('pages/30_策略回测.py', '策略回测', '⚙️'), ('pages/55_P1量化信号.py', 'P1量化信号', '📡')]),
    ('💼 持仓交易', [('pages/45_持仓中心.py', '持仓中心', '💼'), ('pages/40_仓位管理.py', '仓位管理', '📊', 'sub'), ('pages/41_组合收益.py', '组合收益', '📈', 'sub'), ('pages/46_自选股监控.py', '自选股监控', '⭐', 'sub'), ('pages/34_体检扫描.py', '体检扫描', '🩺'), ('pages/47_价格预警.py', '价格预警', '🚨'), ('pages/95_数据导出.py', '数据导出', '📤'), ('pages/42_模拟交易.py', '模拟交易', '🎮'), ('pages/43_实盘交易.py', '实盘交易', '💰'), ('pages/44_智能条件单.py', '智能条件单', '🤖')]),
