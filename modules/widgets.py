...
_NAV_GROUPS = [
    ...
    ('🌐 市场宽度', [('pages/13_市场强弱.py', '市场强弱', '📶'), ('pages/15_市场驱动力.py', '市场驱动力', '🧲'), ('pages/50_市场情绪.py', '市场情绪', '🌡️'), ('pages/23_事件追踪.py', '事件追踪', '📡'), ('pages/16_财报日历.py', '财报日历', '📅'), ('pages/58_连板龙头共振.py', '连板龙头共振', '🐉'), ('pages/59_市场温度计.py', '市场温度计', '🔥'), ('pages/60_事件对比分析.py', '事件对比分析', '🔀'), ('pages/61_广度分化.py', '广度分化', '🌓'), ('pages/62_动量广度共振.py', '动量广度共振', '🔗'), ('pages/63_温度回测.py', '温度回测', '♨️')]),
