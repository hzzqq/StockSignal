...
HOME_GROUPS = [
    ("📘 新手引导", [
        ("📘", "新手教程", "pages/Z_新手教程.py", "5 分钟上手：三步操作 + 模块导览 + 术语表 + 教学视频"),
    ]),
    ("📊 市场纵览", [
        ...
        ("🧮", "市场驱动力", "pages/H_市场驱动力.py", "21指标五维归一化子图：资金/情绪/估值/宏观/技术 vs 上证参考线"),
        ("📊", "市场强弱", "pages/R_市场强弱.py", "指数+关键资金面归一化多线 + 强弱信号灯，一眼看懂当前市场"),
        ...
        ("🌡️", "市场情绪", "pages/P_市场情绪.py", "市场广度与情绪温度计：ADL/ADR/新高新低/VIX/涨停/PCR/北向/融资/PE 综合冷热读数"),
    ]),
    ("🔎 选股研究", [
