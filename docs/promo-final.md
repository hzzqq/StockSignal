...
# 我开源了一个 A 股事件驱动分析平台：4 大免费数据源自动降级 + 68 个页面 + 3197 个测试
...
- 3197 个自动化测试（数据正确性断言 + 离线冒烟 + 后端安全回归）
...
# [开源] 我做的 A 股事件驱动分析平台，4 数据源降级 + 68 页面 + 3197 测试
...
🔥 自己写的 A 股分析工具开源 v0.1.0！免费数据源×4 自动降级、68 个功能页、3197 个测试兜底，双击 bat 就能跑。
