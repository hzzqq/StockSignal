...
def test_cube_renders_without_exception(_patch):
    ...
    at = AppTest.from_file(os.path.join(os.path.dirname(__file__), "..", "pages", "17_市场魔方.py"), default_timeout=90)
    at.run()
...
def test_cube_merge_logic(_patch, monkeypatch):
    ...
    spec = importlib.util.spec_from_file_location("cube_page_test", os.path.join(os.path.dirname(__file__), "..", "pages", "17_市场魔方.py"))
